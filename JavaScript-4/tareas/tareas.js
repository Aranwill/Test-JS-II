...
function agregarPropiedad(objeto, propiedad) {
  ...
  // Tu código:
  // objeto[`${propiedad}`] = null; // Otra forma de acceder a una propiedad del objeto ,como si fuera un array!
  // return objeto;
  objeto[propiedad] = null; // bracket notation (accede a un valor desconocido)
  return objeto;
}
...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  // Devuelve el objeto
  // Tu código:
  delete objeto[`${unaPropiedad}`]; // bracket notation (accede a un valor desconocido)
  return objeto;
}
...
function verificarPassword(usuario, password) {
  ...
  //  return usuario = (usuario, password) => usuario.password === password ? true : false 
